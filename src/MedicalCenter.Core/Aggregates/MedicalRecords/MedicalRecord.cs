...
public class MedicalRecord : BaseEntity, IAggregateRoot, IAuditableEntity
{
    ...
    private readonly List<SharedKernel.Attachment> _attachments = new();
    public IReadOnlyCollection<SharedKernel.Attachment> Attachments => _attachments.AsReadOnly();

    private MedicalRecord() { } // EF Core

    private MedicalRecord(Guid patientId, Guid practitionerId, ValueObjects.Practitioner practitioner, RecordType recordType, string title, string content)
    {
        PatientId = patientId;
    ...
    public static MedicalRecord Create(Guid patientId, Guid practitionerId, ValueObjects.Practitioner practitioner, RecordType recordType, string title, string content)
    {
    ...
    /// </summary>
    public void AddAttachment(Guid adderId, SharedKernel.Attachment attachment)
    {
